...
- Create a conda environment with the miniumum necessary prequisites using `conda env create --file fmsutils.txt -n fmsutils` (these can also be installed by just manually installing xarray, cartopy, windspharm and jupyter to a fresh environment)
