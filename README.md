...
- Create a conda environment with the miniumum necessary prequisites using `conda env create --file fmsutils.txt` (these can also be installed by just manually installing xarray, cartopy and jupyter to a fresh environment)
